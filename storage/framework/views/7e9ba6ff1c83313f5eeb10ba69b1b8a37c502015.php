        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">اضافه کردن تئاتر</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card text-right">
                <div class="card-header"><?php echo e(__('اضافه کردن تئاتر')); ?></div>

                <div class="card-body">
                <form method="POST" action="/storeTheater" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="imagefile" class="col-md-4 col-form-label text-md-left"><?php echo e(__('عکس')); ?></label>
                            <div class="col-md-6">
                                <input id="imagefile" type="file" required class="form-control <?php $__errorArgs = ['imagefile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="act" required autocomplete="act" autofocus></textarea>
                                <?php $__errorArgs = ['act'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="team" required autocomplete="team" autofocus></textarea>
...
unset($__errorArgs, $__bag); ?>" name="description" autocomplete="description" autofocus></textarea>
...
unset($__errorArgs, $__bag); ?>" name="date" required autocomplete="date" autofocus></textarea>
...
<?php echo $__env->make('layouts.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\My Projects\Ticketing\resources\views\admin\theaters\add.blade.php ENDPATH**/ ?>