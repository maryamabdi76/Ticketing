        ...
        <div class="row">
          <div class="col-12">
            <div class="card text-right">
                <div class="card-header"><?php echo e(__('اضافه کردن کنسرت')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="act" class="col-md-4 col-form-label text-md-left"><?php echo e(__('خواننده')); ?></label>
...
<?php echo $__env->make('layouts.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\My Projects\Ticketing\resources\views\admin\concerts\add.blade.php ENDPATH**/ ?>