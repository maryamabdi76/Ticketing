                ...
                <div class="col-lg-8">
                    <div class="checkout-widget checkout-contact">
                        ...
                        <div class="checkout-contact-form">
                            ...
                            <input type="hidden" name="factor_id" id="factor_id" value="<?php echo e($factor[0]->id); ?>">
...
<?php echo $__env->make('layouts.bilito.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\My Projects\Ticketing\resources\views\checkout.blade.php ENDPATH**/ ?>