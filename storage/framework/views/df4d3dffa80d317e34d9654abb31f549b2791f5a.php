                    ...
                    <?php $id=$lastfactors[$i]->shows[0]->id;?>
                        <div class="col-lg-6 ">
                            <div class="card cardbg o-hidden border-0 shadow-lg my-5 p-5">
                                ...
                                <?php endif; ?>
                                    <p class="mt-2 text-right tifany">تاریخ ثبت سفارش : <?php echo e($lastfactors[$i]->purchase_date); ?> </p>
                            </div>
                        </div>
                    <?php endfor; ?>
                </div>
...
<?php echo $__env->make('layouts.prolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\My Projects\Ticketing\resources\views\profile\lastfactors.blade.php ENDPATH**/ ?>