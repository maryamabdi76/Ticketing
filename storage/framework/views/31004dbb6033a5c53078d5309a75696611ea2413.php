        ...
        <div class="row">
          <div class="col-12">
            <div class="card text-right">
                <div class="card-header"><?php echo e(__('ویرایش سالن')); ?></div>

                <div class="card-body">
                <form method="POST" action="/updateSalons">
                        <?php echo csrf_field(); ?>
                        <input id="id" type="hidden" class="form-control " name="id" value="<?php echo e($salons->id); ?>" >
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($salons->name); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="locations_id" value="<?php echo e(old('locations_id')); ?>" >
                                    ...
                                    <option value="<?php echo e($v->id); ?>" <?php if($v->id==$salons->locations_id): ?> selected <?php endif; ?>><?php echo e($v->name); ?></option>
...
<?php echo $__env->make('layouts.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\My Projects\Ticketing\resources\views\admin\salons\edit.blade.php ENDPATH**/ ?>