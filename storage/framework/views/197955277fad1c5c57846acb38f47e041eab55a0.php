        ...
        <div class="row">
          <div class="col-12">
            <div class="card text-right">
                <div class="card-header"><?php echo e(__('اضافه کردن پست')); ?></div>
...
unset($__errorArgs, $__bag); ?>" name="title" required autocomplete="title" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="videofile" class="col-md-4 col-form-label text-md-left"><?php echo e(__('فیلم')); ?></label>
                            <div class="col-md-6">
                                <input id="videofile" type="file" class="form-control <?php $__errorArgs = ['videofile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="videofile">
...
unset($__errorArgs, $__bag); ?>" name="content" required autocomplete="content" autofocus></textarea>
...
<?php echo $__env->make('layouts.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\My Projects\Ticketing\resources\views\admin\posts\add.blade.php ENDPATH**/ ?>