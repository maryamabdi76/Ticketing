        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">ویرایش کنسرت</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card text-right">
                <div class="card-header"><?php echo e(__('ویرایش کنسرت')); ?></div>

                <div class="card-body">
                <form method="POST" action="/updateConcert" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <input id="id" type="hidden" class="form-control " name="id" value="<?php echo e($concert->id); ?>" >
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($concert->name); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="" class="col-md-4 col-form-label text-md-left"><?php echo e(__('عکس های کنسرت')); ?></label>
                            <div class="col-md-6">
                                ...
                                <img class="img-fluid" src="<?php echo e(asset('/').$photo->path); ?>" width="32%" alt=""/>
                                    ...
                                    <?php if($concert->Images()->get()->count()>1): ?>
                                    <a href="/deleteConcertPhoto/<?php echo e($photo->id); ?>/<?php echo e($concert->id); ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" title="حذف" onclick="return confirm('Are you sure you want to delete this item?');" >
...
unset($__errorArgs, $__bag); ?>" name="act" required autocomplete="act" autofocus><?php echo e($concert->act); ?></textarea>
                                <?php $__errorArgs = ['act'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="team" required autocomplete="team" autofocus><?php echo e($concert->team); ?></textarea>
                            ...
                            <div class="col-md-6">
                                 <?php $__currentLoopData = $genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <input class="form-check-input" name="genre[]" type="checkbox" id="<?php echo e($v->id); ?>" value="<?php echo e($v->id); ?>"
                                                       <?php $__currentLoopData = $concert->genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($v->id==$genre->id): ?> checked <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>>
...
unset($__errorArgs, $__bag); ?>" name="date" required autocomplete="date" autofocus><?php echo e($concert->date); ?></textarea>
...
<?php echo $__env->make('layouts.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\My Projects\Ticketing\resources\views\admin\concerts\edit.blade.php ENDPATH**/ ?>