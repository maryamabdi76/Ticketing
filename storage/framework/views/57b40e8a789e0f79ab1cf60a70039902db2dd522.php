        ...
        <div class="row">
          <div class="col-12">
            <div class="card text-right">
                <div class="card-header"><?php echo e(__('ویرایش بخش')); ?></div>
                ...
                <div class="card-body">
                        <form method="POST" action="/updateSegment">
                            <?php echo csrf_field(); ?>
                            <input id="id" type="hidden" class="form-control " name="id" value="<?php echo e($segment->id); ?>" >
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($segment->name); ?>" autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="row" value="<?php echo e($segment->row); ?>" required autocomplete="row" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="seat" value="<?php echo e($segment->seat); ?>" required autocomplete="seat" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="capicity" value="<?php echo e($segment->capicity); ?>" required autocomplete="capicity" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="orders" value="<?php echo e($segment->orders); ?>" required autocomplete="orders" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="price" value="<?php echo e($segment->price); ?>" required autocomplete="price" autofocus>
                                            ...
                                            <ul class="seat--area">
                                                <li class="front-seat">
                                                    <ul>
                                                        ...
                                                        ?>
                                                            <li class="single-seat" id="<?php echo e($seat_number); ?>" data-toggle="tooltip" data-placement="top" title="قیمت صندلی: <?php echo e($segment->price); ?> تومان">
...
<?php echo $__env->make('layouts.admin.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\My Projects\Ticketing\resources\views\admin\segments\edit.blade.php ENDPATH**/ ?>